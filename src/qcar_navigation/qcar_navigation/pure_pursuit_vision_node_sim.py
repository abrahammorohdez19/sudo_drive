...
class PurePursuitVisionNode(Node):
    ...
    def __init__(self):
        super().__init__('pure_pursuit_vision_node_sim')
        ...
        self.declare_parameter('steer_gain',          15.0)   # ganancia pure pursuit en px
        self.declare_parameter('warmup_frames',       30)     # frames iniciales en espera
        self.declare_parameter('xlook_tol_px',       200.0)   # máx diferencia x_look vs centroide
        ...
        self.declare_parameter('k_curv_offset',     4000.0)   # px extra por unidad de curvatura
        ...
        # Velocidad desde el odómetro simulado (nav_msgs/Odometry)
